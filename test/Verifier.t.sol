...
contract VerifierTest is Test {
    ...
    // TODO: Multiple input proof tests

    function setUp() public {
        string memory wrapper_code = vm.readFile("test/wrappers/VerifierWrapper.huff");

        // Single Input Verifiers
        huffSingleInputVerifier = IHuffVerifier(HuffDeployer.deploy_with_code("../test/single-input/SampleVerifier", wrapper_code));
